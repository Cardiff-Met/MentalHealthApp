...
export default function MoodPage() {
    ...
    if (result?.isCrisis) {
        return (
            <div style={{ maxWidth: '600px', margin: '50px auto', padding: '2rem', border: '2px solid red', borderRadius: '8px' }}>
                <h2 style={{ color: 'red' }}>⚠️ Immediate Support Available</h2>
                <p>It sounds like you're going through a really difficult time. Please reach out for help right now.</p>

                <ul style={{ lineHeight: '2' }}>
                    <li><strong>Samaritans:</strong> <a href="tel:116123">116 123</a> — free, 24/7</li>
                    <li><strong>NHS Urgent Mental Health:</strong> <a href="tel:111">111</a> then option 2</li>
                    <li><strong>Cardiff Met Wellbeing:</strong> <a href="https://www.cardiffmet.ac.uk/wellbeing">cardiffmet.ac.uk/wellbeing</a></li>
                </ul>
        ...
        <div style={{ maxWidth: '600px', margin: '50px auto', padding: '2rem' }}>
            ...
            <form onSubmit={handleSubmit}>
                <div style={{ marginBottom: '1.5rem' }}>
                    ...
                    <p style={{ fontSize: '0.8rem', color: '#666' }}>1 = very low, 5 = great</p>
                </div>
